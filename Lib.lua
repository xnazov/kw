...
local defaults; do
    ...
    local types = {}; do
        ...
        function types:Section(name)
            ...
            local secondarySize = UDim2.new(1, -2, 0, 18);
        ...
        function types:Dropdown(name, options, callback)
            ...
            local callback = callback or function() end;
            local list = options.list or {};
            local droptype = options.type or 'single' -- or multi
            local SearchOption = options.search or false
            local default = options.default or ((droptype == 'multi' and {table.unpack(list)}) or (droptype == 'single' and list[1]))
            ...
            button.MouseButton1Click:connect(function()
                ...
                check:FindFirstChild('dropdown_lbl'):WaitForChild('Selection').Text = (droptype == 'multi' and tostring("#"..tostring(#location[flag]).." selected")) or location[flag];
                local c = 0;
                for i, v in next, list do
                    c = c + 20;
                end
                ...
                if SearchOption then
                    local searchbox = library:Create('TextBox', {
                        ...
                        BackgroundColor3 = library.options.btncolor;
                        BorderColor3 = library.options.bordercolor;
                        Text = utf8.char(128269).."Search Box!";
                        Font = library.options.font;
                        TextSize = library.options.fontsize;
                        LayoutOrder = 0;
                        Parent = container;
                        ZIndex = 5;
                        TextColor3 = ((droptype == 'multi' and table.find(location[flag], v)) and Color3.fromRGB(0, 255, 0)) or ((droptype == 'single' and location[flag] == v) and Color3.fromRGB(0, 255, 0)) or library.options.textcolor;
                        TextStrokeTransparency = library.options.textstroke;
                        TextStrokeColor3 = library.options.strokecolor;
                    })

                    searchbox:GetPropertyChangedSignal("Text"):Connect(function()
                        for aaaah, fuck in pairs(container:GetChildren()) do
                            if fuck.ClassName == 'TextButton' then
                                fuck.Visible = false
                                if searchbox.Text ~= nil and searchbox.Text ~= "" then
                                    if string.find(string.lower(fuck.Text), string.lower(searchbox.Text)) then
                                        fuck.Visible = true
                                    end
                                else
                                    fuck.Visible = true
                        ...
                        local c = 20;
                        for a, b in pairs(container:GetChildren()) do
                ...
                for i, v in next, list do
                    local btn = library:Create('TextButton', {
                        ...
                        Font = library.options.font;
                        TextSize = library.options.fontsize;
                        LayoutOrder = ((droptype == 'multi' and table.find(location[flag], v)) and 1) or i+1;
                        Parent = container;
                        ZIndex = 5;
                        TextColor3 = ((droptype == 'multi' and table.find(location[flag], v)) and Color3.fromRGB(0, 255, 0)) or ((droptype == 'single' and location[flag] == v) and Color3.fromRGB(0, 255, 0)) or library.options.textcolor;
                        TextStrokeTransparency = library.options.textstroke;
                    ...
                    btn.MouseButton1Click:connect(function()
                        ...
                        elseif droptype == 'multi' then
                            if not table.find(location[flag], btn.Text) then
                                table.insert(location[flag], btn.Text)
                            else
                                for aaa = 1, #location[flag] do
                                    if location[flag][aaa] == btn.Text then
                                        table.remove(location[flag], aaa)
                                    end
                                end
                            end
                        end
                        for aaaah, fuck in pairs(container:GetChildren()) do
                            if fuck.ClassName == 'TextButton' then
                                fuck.TextColor3 = ((droptype == 'multi' and table.find(location[flag], fuck.Text)) and Color3.fromRGB(0, 255, 0)) or ((droptype == 'single' and location[flag] == fuck.Text) and Color3.fromRGB(0, 255, 0)) or library.options.textcolor;
                            end
                        end

                        check:FindFirstChild('dropdown_lbl'):WaitForChild('Selection').TextColor3 = library.options.textcolor
                        check:FindFirstChild('dropdown_lbl'):WaitForChild('Selection').Text = (droptype == 'multi' and tostring("#"..tostring(#location[flag]).." selected")) or btn.Text;
            ...
            local function reload(self, array)
                ...
                check:WaitForChild('dropdown_lbl').Selection.Text = (droptype == 'multi' and tostring("#"..tostring(#location[flag]).." selected")) or location[flag];
                check:FindFirstChild('dropdown_lbl'):WaitForChild('Selection').TextColor3 = library.options.textcolor
                game:GetService('Debris'):AddItem(container, 0)
            end
    ...
    default = {
        ...
        sectncolor     = Color3.fromRGB(10, 10, 10);
...
library.options.titlesize = 22
library.options.titlefont = "FredokaOne"
library.options.font = "FredokaOne"
library.options.fontsize = 14
